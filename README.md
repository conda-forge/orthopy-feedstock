About orthopy-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/orthopy-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11389&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/orthopy-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `orthopy` can be installed with `conda`:
...
```
mamba install orthopy
```

It is possible to list all of the versions of `orthopy` available on your platform with `conda`:
...
```
mamba search orthopy --channel conda-forge
```
...
mamba repoquery search orthopy --channel conda-forge

# List packages depending on `orthopy`:
mamba repoquery whoneeds orthopy --channel conda-forge

# List dependencies of `orthopy`:
mamba repoquery depends orthopy --channel conda-forge
```
